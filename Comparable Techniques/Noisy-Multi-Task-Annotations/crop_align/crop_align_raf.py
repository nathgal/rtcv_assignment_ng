...
import numpy as np
import argparse
from align import MyFaceAligner_RAF



parser = argparse.ArgumentParser()
parser.add_argument("--root", type=str, default='C:/Users/natha/Desktop/noisyFER/datasets/rafd/basic')
args = parser.parse_args()


def crop_align_raf(root):
    img_root = os.path.join(root, 'Image/original')
